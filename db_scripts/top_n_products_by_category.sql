-- SELECT * FROM top_n_products_by_category(3, 'Electronics', '2023-01-01', '2024-12-31');

CREATE OR REPLACE FUNCTION top_n_products_by_category(n INT, category_param TEXT, start_date TEXT, end_date TEXT)
...
BEGIN
    ...
    SELECT EXISTS (SELECT 1 FROM products WHERE category = category_param) INTO category_exists;
